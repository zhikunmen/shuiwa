module chessCommonLib {
	export class SysMsgMc extends eui.Component {
		...
		public static isShowWorldChat:boolean = true;
		public constructor(isHundred?:boolean) {
			super();
			if(isHundred != undefined)
				this._isHundred = isHundred;
			this.visible = false;
		...
		public initUI(): void {
			...
			SysMsgMc.isShowWorldChat = ConfigMgr.getInstance().gameOptions.horn;
