...
module chessCommonLib {
     ...
     * 3.用chat_lb控制排版显示
     */
    export class chatComponent extends egret.Sprite {
        ...
        constructor(data:any) {
            ...
            this.init();
            console.error("this.chatComponent",this.data);
        }
 ...
 */
        public showContent(length:number = 720): egret.Sprite {
            if (!this.emoj) {
                this.emoj = new egret.Sprite();
                this.emoj.x = 10;
                this.addChild(this.emoj);
        ...
        private formatTxt(strArr: any[], emojArr: any[]) {
            for (let i = 0; i < strArr.length; i++) {
                ...
                //以文本对象作为测量基准
                var test = new ChatWordItem(strArr[i]);
                ...
                if (isSlice) {
                    ...
                    if (reg1) {
                        ...
                        test = new ChatWordItem(_text3 + reg1[index1]);
                    }
                }
                ...
                if (isSlice) {
                    ...
                    let tempTest = new ChatWordItem(remain);
   ...
   */
        private sliceArray(array: any[]) {
            ...
            for (let i = 0; i < array.length; i++) {
                _width = _width + new ChatWordItem(array[i]).width
