declare module table {
    ...
    class TableFishDraw {
         ...
         * 奖励1
         */
        award1: TableFishDraw.Award1Item[];
        /**
         * 奖励2
         */
        award2: TableFishDraw.Award2Item[];
        GetType(): string;
    }
    module TableFishDraw {
        class Award1Item {
            goodId: number;
            goodNbr: number;
            chance: number;
...
declare module Cmd {
    ...
    class GetInfoTurnTableCmd_C {
        /**
         * 1:请求抽奖方式 2:请求抽奖结果 3:请求倒计时(捕鱼游戏内转盘) 4:请求抽奖结果(捕鱼游戏内转盘)
         */
        opType: number;
        GetType(): string;
    }
     ...
     * 捕鱼抽奖信息
     */
    class GetFishLuckyDrawInfoLobbyCmd_C {
        GetType(): string;
    }
    class GetFishLuckyDrawInfoLobbyCmd_S {
        /**
         * 击杀数量
         */
        killNum: number;
     ...
     * 捕鱼抽奖
     */
    class GetFishLuckyDrawPrizeLobbyCmd_C {
        GetType(): string;
    }
    class GetFishLuckyDrawPrizeLobbyCmd_S {
        /**
         * 奖品
         */
        rewards: Cmd.RewardItem[];
...
declare module table {
    ...
    class TableFish {
         ...
         * 产出
         */
        fishAward: TableFish.FishAwardItem[];
        /**
         * 优先权重
         */
...
declare module table {
    ...
    class TableFishGun {
         ...
         * 解锁额外奖励
         */
        otherAward: TableFishGun.OtherAwardItem[];
        GetType(): string;
    }
    module TableFishGun {
        class OtherAwardItem {
            goodId: number;
            goodNbr: number;
        }
    }
...
declare module table {
    ...
    class TableGoodsConfig {
         ...
         * 售价
         */
        sellPrice: TableGoodsConfig.SellPriceItem[];
        /**
         * 每日赠送金币
         */
        giveGold: number;
