...
(function (match) {
    ...
    var MatchConst = (function () {
        ...
        MatchConst.RES_JSON = "resource/wxmatch/match.res_9abf7d1f.json";
        MatchConst.THM_JSON = "resource/match/gameEui_ce9c7a74.json";
        /**
         * 主界面需要加载的资源
         */
    ...
    (function (GoodType) {
        /**房卡 */
        GoodType[GoodType["TYPE_CARD"] = 1] = "TYPE_CARD";
        /**钻石*/
...
(function (match) {
    var WxBuyuReward = (function (_super) {
        ...
        WxBuyuReward.prototype.updateItem = function () {
        };
        WxBuyuReward.prototype.onItemHandle = function (e) {
            var fish = ConfigMgr.getInstance().getFishByfishID(this.fishContain.selectedItem);
    ...
    var FishTypeItem = (function (_super) {
        ...
        function FishTypeItem() {
            var _this = _super.call(this) || this;
            _this.skinName = "FishTypeItemSkin";
            return _this;
        }
    ...
    var WxBuyuGoodItem = (function (_super) {
        ...
        WxBuyuGoodItem.prototype.dataChanged = function () {
            ...
            var conf = ConfigMgr.getInstance().getGoodCfgById(good.goodId);
...
(function (match) {
    ...
    function judgeItemIsEnough(goodId, goodNum) {
        ...
        else if (goodId == match.GoodType.TYPE_CARD) {
        ...
        WxGameDetail.prototype.childrenCreated = function () {
            ...
            if (this._data) {
                ...
                if (config) {
                    ...
                    else if (config.HaoPaiMatchCost[0].goodId == match.GoodType.TYPE_CARD) {
...
(function (match) {
    var WxTopOpBtn = (function (_super) {
        ...
        WxTopOpBtn.prototype.onUserInfoChanged = function (evt) {
            if (this.diamond_btn) {
                this.diamond_btn.label = uniLib.UserInfo.chips.toString();
            }
            if (this.ticket_btn) {
        ...
        WxTopOpBtn.prototype.onTouchHandler = function (evt) {
            if (evt.target == this.diamond_btn) {
                ...
                if (WxTopOpBtn.HAS_HPW_MATCH == false)
                    return;
                LoadPanelTipMgr.getInstance().loadRes(match.MatchConst.HPW_MATCH, function () { match.OnGetSceneInfoHpMatchCmd_C(match.BigSceneType.TYPE_MATCH, match.GameId.ID_MATCH_PIG); });
            }
