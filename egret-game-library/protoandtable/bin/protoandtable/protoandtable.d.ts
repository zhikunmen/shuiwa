...
declare module Cmd {
    ...
    module BSClubCanTransferCmd_CS {
        class TransferData {
            /**
             * 金币数量
             */
...
declare module Cmd {
    ...
    class EnterRoomCommonCmd_S {
        ...
        /**
         *  2.5D
         *  repeated GreatWall greatWall            = 5;    // 牌墙
         * 观战字段1表示观战模式
         */
        visitor: number;
        GetType(): string;
...
declare module Cmd {
     ...
     * 绑定
     */
    class BindOtherLobbyUidLobbyCmd_CS {
        /**
         * 房卡uid
         */
        uid: number;
...
declare module Cmd {
     ...
     * 平台金钱带入带出
     */
    class PlatMoneyBringInOrOutCmd_CS {
        money: number;
        /**
         * true: 带入 false: 带出
         */
     ...
     * 询问修改名称费用
     */
    class ChangeNicknameMoneyQueryCmd_CS {
        money: number;
        GetType(): string;
    }
    /**
     * 填写推荐人
     */
    class WriteInviterActivityCmd_CS {
        uid: number;
        user: Cmd.UserBaseInfo;
        resultCode: number;
        GetType(): string;
     ...
     * 查询已填写推荐人
     */
    class QueryWriteInviterActivityCmd_CS {
        uid: number;
        user: Cmd.UserBaseInfo;
        GetType(): string;
    }
     ...
     * 查询推荐人
     */
    class QueryInviterActivityCmd_CS {
     ...
     */
    class ReturnJoinMemberMatchGroupCmd_S {
        matchId: number;
        uid: number;
        nickname: string;
        /**
...
declare module Cmd {
     ...
     *  S-&gt;C 返回俱乐部某个成员金钱账单
     */
    class MemberChipsStatementClubCmd_CS {
        filter: Cmd.FilterInfo;
...
declare module Cmd {
     ...
     * 修改玩家绑定关系
     */
    class RequestChangeParentIdMatchGroupCmd_C {
        /**
         * 下线玩家id
         */
        uid: number;
     ...
     * 回应玩家绑定关系
     */
    class ReturnChangeParentIdMatchGroupCmd_CS {
        /**
         * 上线玩家id
         */
        uid: number;
     ...
     * 包月续费
     */
    class RenewPayTimeMatchGroupCmd_C {
        /**
         * 匹配号id
         */
        matchId: number;
     ...
     * 匹配号内排行
     */
    class OrderListMatchGroupCmd_C {
        /**
         * 匹配id
         */
        matchId: number;
     ...
     * 匹配号内排行
     */
    class OrderListMatchGroupCmd_S {
        /**
         * 匹配id
         */
        matchId: number;
     ...
     * 请求俱乐部战绩
     */
    class RequestMatchGroupRoomListCmd_C {
        /**
         * 匹配号
         */
        matchId: number;
     ...
     * 返回俱乐部战绩
     */
    class ReturnMatchGroupRoomListCmd_S {
        /**
         * 俱乐部
         */
        roomList: Cmd.MathGroupRoomInfo[];
     ...
     * 导出战绩
     */
    class ExportHistoryMatchGroupCmd_C {
        fromMatchId: number;
        toMatchId: number;
        /**
         * 1表示清空原战绩
     ...
     * 俱乐部消耗
     */
    class RequestMatchGroupRoomCostListCmd_CS {
        /**
         * 匹配号
         */
        matchId: number;
     ...
     * 返回小黑屋的数据
     */
    class ReturnDarkMemberInfoMatchGroupCmd_S {
        /**
         * 小黑屋id
         */
        dark_id: number;
     ...
     * 返回一个玩家的数据
     */
    class ReturnOneMemberInfoMatchGroupCmd_S {
        /**
         * 玩家信息
         */
     ...
     * 刷新某个成员信息
     */
    class RefreshMemberInfoMatchGroupCmd_S {
        /**
         * 匹配号
         */
        matchId: number;
     ...
     * 匹配主,清楚合伙人统计相关数据
     */
    class ClearPartnerRecordDataMatchGroupCmd_C {
        /**
         * 俱乐部id
         */
        matchId: number;
     ...
     * 匹配主,清楚玩家数据
     */
    class ClearChoseUserClubDataCmd_C {
        /**
         * 俱乐部id
         */
        matchId: number;
    ...
    class OperateMemberListMatchGroupCmd_S {
        uid: number;
        matchId: number;
        /**
     ...
     * 导入白名单
     */
    class ImportWhiteListMatchGroupCmd_C {
        fromMatchId: number;
        toMatchId: number;
        GetType(): string;
    }
     ...
     * 重置某个玩家的推广奖励
     */
    class ResetTaxRewardMatchRoomCmd_C {
        matchId: number;
        /**
         * 不填或0表示清除所有
         */
     ...
     * 玩家是否同意操作者的捐献需求
     */
    class AgreeDonateChipsToUserMatchRoomCmd_CS {
        /**
         * 操作者id
         */
        uid: number;
     ...
     * 请求捐献操作者汇总信息
     */
    class DonateHistorySummaryMatchRoomCmd_C {
        /**
         * 匹配号
         */
        matchId: number;
     ...
     * 请求捐献操作者汇总信息
     */
    class DonateHistorySummaryMatchRoomCmd_S {
        /**
         * 匹配号
         */
        matchId: number;
     ...
     * 请求游戏基金变动历史
     */
    class GameMatchPointHistoryMatchRoomCmd_C {
        /**
         * 匹配号
         */
        matchId: number;
     ...
     * 返回请求捐献历史
     */
    class GameMatchPointHistoryMatchRoomCmd_S {
        /**
         * 匹配号
         */
        matchId: number;
     ...
     * 退出俱乐部界面
     */
    class ExitMatchGroupCmd_C {
        GetType(): string;
    }
    /**
     * 广播当前桌子最新状况
     */
    class LatestMatchRoomInfoGroupCmd_Brd {
        /**
     ...
     * 请求最近进入过匹配号的人
     */
    class RecentVisitListMatchGroupCmd_C {
        /**
         * 匹配id
         */
        matchId: number;
     ...
     * 返回最近进入过匹配号的人
     */
    class RecentVisitListMatchGroupCmd_S {
        /**
         * 匹配id
         */
        matchId: number;
     ...
     */
    class OperateFlowerMatchGroupCmd_CS {
        /**
         * 匹配id
         */
        matchId: number;
    ...
    class OperateFlowerMatchGroupBCmd_CS {
        /**
         * 匹配id
         */
        matchId: number;
     ...
     * AA房费扣花后 通知下客户端显示
     */
    class AAFlowerRoomChargeMatchGroupCmd_S {
        /**
         * 具体房费扣除数目
         */
     ...
     * 红花待处理界面
     */
    class BeProcessedFlowerMatchGroupCmd_CS {
        /**
         * 匹配id
         */
        matchId: number;
     ...
     * 获取红花变化记录
     */
    class FlowerRecordMatchGroupCmd_CS {
        /**
         * 匹配id
         */
        matchId: number;
     ...
     */
    class SearchCurTotalFlowerMatchGroupCmd_CS {
        /**
         * 匹配id
         */
        matchId: number;
     ...
     * 改变俱乐部红花初始总值
     */
    class ChangeTotalFlowerMatchGroupCmd_CS {
        /**
         * 匹配id
         */
        matchId: number;
     ...
     * 推送玩家最新红花数
     */
    class PushCurFlowerMatchGroupCmd_S {
        /**
         * 匹配id
         */
        matchId: number;
     ...
     * 添加、清除备注分数
     */
    class RemarkPointMatchGroupCmd_CS {
        /**
         * 匹配id
         */
        matchId: number;
     ...
     * 添加、清除昵称备注
     */
    class RemarkNickNameMatchGroupCmd_CS {
        /**
         * 匹配id
         */
        matchId: number;
     ...
     * 获取可导入群列表
     */
    class GetCanImportMemberListMatchGroupCmd_CS {
        /**
         * 匹配id
         */
        matchId: number;
     ...
     * 成员导入
     */
    class ImportMemberListMatchGroupCmd_CS {
        fromMatchId: number;
        toMatchId: number;
        /**
         * 返回码
     ...
     * 获取可邀请成员列表
     */
    class GetCanInviteMemberListMatchGroupCmd_CS {
        /**
         * 匹配id
         */
        matchId: number;
     ...
     * 邀请指定玩家到俱乐部中
     */
    class InviteMemberMatchGroupCmd_CS {
        /**
         * 匹配id
         */
        matchId: number;
     ...
     * 邀请指定玩家到俱乐部中 广播
     */
    class InviteMemberMatchGroupCmd_Brd {
        /**
         * 邀请者
         */
     ...
     * 清除战绩 -- 暂停开房后能清除掉战绩数据
     */
    class ClearRecordMatchGroupCmd_CS {
        matchId: number;
        /**
         * 返回码
         */
     ...
     * 清除红花总奖励
     */
    class ClearFlowerRewardMatchGroupCmd_CS {
        matchId: number;
        /**
         * 返回码
         */
     ...
     * 获取红花奖励记录
     */
    class GetFlowerRewardRecordMatchGroupCmd_CS {
        matchId: number;
        /**
         * 返回码
         */
     ...
     * 修改俱乐部楼层名称
     */
    class SetFloorNameMatchGroupCmd_CS {
        matchId: number;
        floorId: number;
        floorName: string;
        /**
     ...
     * 群主进入合伙人界面 获取合伙人数据
     */
    class GetPartnerRecordsMatchGroupCmd_CS {
        matchId: number;
        floorId: number;
        /**
         * 返回码
     ...
     * 操作指定合伙人
     */
    class OperatePartnerMatchGroupCmd_CS {
        matchId: number;
        /**
         * 1/2 添加、删除
         */
     ...
     * 群主申请解除合伙人 发送给合伙人的广播
     */
    class RemovePartnerMatchGroupCmd_Brd {
        matchId: number;
        matchName: string;
        GetType(): string;
    }
     ...
     * 合伙人 回复是否解除合伙关系
     */
    class ReplyRemovePartnerMatchGroupCmd_CS {
        matchId: number;
        /**
         * 1、2 同意、拒绝
         */
     ...
     * 获取组员详情界面
     */
    class GetMemberRecordsMatchGroupCmd_CS {
        matchId: number;
        /**
         * 获取目标合伙人数据
         */
     ...
     * 获取可导入组员列表
     */
    class GetCanImportMemberList2MatchGroupCmd_CS {
        /**
         * 当前俱乐部id
         */
        curMatchId: number;
     ...
     * 查询指定成员是否可导入
     */
    class GetCanImportUserInfoMatchGroupCmd_CS {
        /**
         * 当前俱乐部id
         */
        curMatchId: number;
     ...
     * 添加指定组员到俱乐部中
     */
    class ImportMember2MatchGroupCmd_CS {
        /**
         * 匹配id
         */
        matchId: number;
     ...
     * 移除指定组员
     */
    class RemoveMemberMatchGroupCmd_CS {
        /**
         * 匹配id
         */
        matchId: number;
     ...
     * 队长手动添加弹窗
     */
    class PopupPartnerHandAddMatchGroupCmd_S {
        /**
         * 队长信息
         */
     ...
     * 设置合伙人返利数值
     */
    class SetPartnerPumpProportionMatchGroupCmd_CS {
        /**
         * 匹配id
         */
        matchId: number;
     ...
     */
    class SetPartnerFlowerCtrMatchGroupCmd_CS {
        /**
         * 匹配id
         */
        matchId: number;
     ...
     *  设置定时器
     */
    class SetPauseTimerMatchGroupCmd_CS {
        /**
         * 匹配id
         */
        matchId: number;
     ...
     * 清空玩家输赢数据
     */
    class CleanMemberWinPointMatchGroupCmd_CS {
        /**
         * 匹配id
         */
        matchId: number;
     ...
     * 获取清空的操作记录
     */
    class GetCleanRecordMatchGroupCmd_CS {
        /**
         * 匹配id
         */
        matchId: number;
     ...
     * 指定一个记账地址
     */
    class SetBookingUrlMatchGroupCmd_CS {
        /**
         * 匹配id
         */
        matchId: number;
     ...
     * 申请进入记账本地址
     */
    class RequestBookingUrlMatchGroupCmd_CS {
        /**
         * 匹配id
         */
        matchId: number;
     ...
     * 获取俱乐部审批记录
     */
    class GetApproveRecordMatchGroupCmd_C {
        /**
         * 匹配id
         */
        matchId: number;
     ...
     * 获取俱乐部审批记录
     */
    class GetApproveRecordMatchGroupCmd_S {
        resultCode: number;
        /**
         * 页数
         */
     ...
     * 打开活动界面
     */
    class OpenActivityMatchGroupCmd_C {
        /**
    ...
    class OpenActivityMatchGroupCmd_S {
        /**
         * 活动Id
         */
        actId: number;
     ...
     * 设置活动
     */
    class SetActivityMatchGroupCmd_C {
        /**
         * 标题
         */
        title: string;
    ...
    class SetActivityMatchGroupCmd_S {
        resultCode: number;
        desc: string;
        GetType(): string;
    }
     ...
     * 删除活动
     */
    class DeleteActivityMatchGroupCmd_C {
        /**
         * 活动Id
         */
        actId: number;
    ...
    class DeleteActivityMatchGroupCmd_S {
        resultCode: number;
        desc: string;
        GetType(): string;
    }
     ...
     * 查看排行榜
     */
    class GetActivityRankMatchGroupCmd_C {
        /**
         * 活动Id
         */
        actId: number;
    ...
    class GetActivityRankMatchGroupCmd_S {
        ranklist: rankInfo[];
        /**
         * 最大页数
         */
    ...
    class GetRankInfoMatchGroupCmd_CS {
        matchId: number;
        /**
         * 1:今日 2:本月 3:昨日
         */
...
declare module Cmd {
     ...
     * 删除战绩,避免家庭矛盾
     */
    class DelPlayedDataHistoryCmd_C {
        /**
         * 某一个房间号的战绩,0表示全部
         */
        roomId: number;
     ...
     */
    class GetGameDataHistoryForMatchCmd_C {
        /**
         * 俱乐部id
         */
        matchId: number;
    ...
    class GetGameDataHistoryForMatchCmd_S {
        /**
         * 返回码 默认0为操作成功
         */
        resultCode: number;
     ...
     * 牌局中的疲劳值变化明细
     */
    class GetGameFlowerDetailHistoryCmd_C {
        /**
         * 全局唯一的房间id 用于索引战绩数据
         */
        globalRoomId: number;
    ...
    class GetGameFlowerDetailHistoryCmd_S {
        curPage: number;
        maxPage: number;
        gameFlowerDetail: GameFlowerDetail[];
        GetType(): string;
    }
    class GameFlowerDetail {
        /**
         * 第几次
         */
        nbr: number;
...
declare module Cmd {
     ...
     * 金币场场次信息
     */
    class GetGoldCoinSceneInfoHpMatchCmd_C {
        GetType(): string;
    }
    class GetGoldCoinSceneInfoHpMatchCmd_S {
        infos: SceneInfo[];
        /**
         * 默认进那个场次
         */
     ...
     * 挑战赛场次信息
     */
    class GetChallengeInfoHpMatchCmd_C {
        GetType(): string;
    }
    class GetChallengeInfoHpMatchCmd_S {
        infos: ChallengeInfo[];
        GetType(): string;
    }
    /**
     * 闯关信息
     */
    class GetRushInfoHpMatchCmd_C {
        GetType(): string;
    }
    class GetRushInfoHpMatchCmd_S {
        infos: RushInfo[];
        GetType(): string;
    }
    /**
...
declare module Cmd {
     ...
     * 请求我加入过的联盟
     */
    class RequestJoinedListLeagueCmd_C {
        /**
         * 可以不填
         */
        uid: number;
     ...
     * 请求我加入过的联盟
     */
    class ReturnJoinedListLeagueCmd_S {
        list: LeagueInfo[];
        GetType(): string;
    }
    /**
     ...
     * 请求下级联盟列表
     */
    class RequestChildListLeagueCmd_C {
        /**
         * 联盟id
         */
        leagueId: number;
     ...
     * 返回下级联盟列表
     */
    class ReturnChildListLeagueCmd_S {
        /**
         * 联盟id
         */
        leagueId: number;
     ...
     * 请求更改下级税收百分比
     */
    class ChangeChildTaxLeagueCmd_CS {
        /**
         * 联盟id
         */
        leagueId: number;
     ...
     * 请求下级指定联盟的详细信息
     */
    class RequestChildMemberInfoLeagueCmd_C {
        /**
         * 联盟id
         */
        leagueId: number;
     ...
     * 返回下级指定联盟的详细信息白名单
     */
    class ReturnChildMemberInfoLeagueCmd_S {
        /**
         * 联盟id
         */
        leagueId: number;
     ...
     * 申请白名单消息列表,玩家请求后主动推给匹配主
     */
    class JoinMemberListLeagueCmd_S {
        /**
         * 匹配号
         */
        leagueId: number;
     ...
     * 修改某人的合伙人关系
     */
    class ChangePartnerLeagueCmd_CS {
        /**
         * 联盟id
         */
        leagueId: number;
     ...
     * 请求联盟房间贡献明细
     */
    class RequestRoomTaxLeagueCmd_C {
        /**
         * 联盟id
         */
        leagueId: number;
     ...
     * 返回联盟房间贡献明细
     */
    class ReturnRoomTaxLeagueCmd_S {
        /**
         * 联盟id
         */
        leagueId: number;
     ...
     * 请求最新操作历史玩家列表
     */
    class LatestOperateLeagueCmd_C {
        /**
     ...
     * 返回最新操作历史玩家列表
     */
    class LatestOperateLeagueCmd_S {
        /**
         * 操作类型,可以是联盟id,茶楼id或者匹配号id,目前用联盟id
         */
        opid: number;
...
declare module Cmd {
    ...
    class UpdateSystemControlValue_CS {
        /**
         * 系统分
         */
        sysPoint: number;
     ...
     * 控制开奖
     */
    class SystemControlOpenLottery_C {
        /**
         * 中奖Id
         */
        lotteryId: number;
     ...
     * 控制台后台
     */
    class UpdateSystemControlData_S {
        /**
         * 结算数据
         */
...
declare module Cmd {
     ...
     */
    class RequestJoinedSZLeagueCmd_CS {
        /**
         * 当前俱乐部id
         */
        matchId: number;
     ...
     * 有申请加入大联盟的时候 推送下审批列表
     */
    class JoinMatchListSZLeagueCmd_S {
        /**
         * 大联盟id
         */
        leagueId: number;
     ...
     * 获取当前大联盟所存在的老友圈列表
     */
    class GetMatchListSZLeagueCmd_CS {
        /**
         * 大联盟id
         */
        leagueId: number;
     ...
     * 备注大联盟内的指定俱乐部
     */
    class RemarkMatchSZLeagueCmd_CS {
        /**
         * 大联盟id
         */
        leagueId: number;
     ...
     * 踢出指定俱乐部
     */
    class KickOutMatchSZLeagueCmd_CS {
        /**
         * 大联盟id
         */
        leagueId: number;
     ...
     * 玩家主动退出大联盟
     */
    class ActiveExitSZLeagueCmd_CS {
        /**
         * 大联盟id
         */
        leagueId: number;
    ...
    class CreatePlayFloorSZLeagueCmd_CS {
        resultCode: number;
        GetType(): string;
    }
    /**
     * 操作楼层内的玩法层
     */
    class OperatePlayFloorSZLeagueCmd_CS {
        /**
         * 大联盟id
         */
        leagueId: number;
     ...
     * 钻石补充
     */
    class AddDiamondSZLeagueCmd_CS {
        /**
         * 大联盟id
         */
        leagueId: number;
     ...
     * 疲劳值设置列表。。其实就是玩家的成员列表
     */
    class GetMemberListSZLeagueCmd_CS {
        /**
         * 大联盟id
         */
        leagueId: number;
     ...
     * 操作玩家疲劳值
     */
    class ChangeMemberFlowerSZLeagueCmd_CS {
        /**
         * 大联盟id
         */
        leagueId: number;
     ...
     */
    class GetFloorListSZLeagueCmd_CS {
        /**
         * 大联盟id
         */
        leagueId: number;
     ...
     * 消耗统计数据
     */
    class ConsumeStatisticsInSZLeague {
        /**
         * 游戏名称
         */
        gameName: string;
     ...
     */
    class GetChangeMemberFlowerRecordSZLeagueCmd_CS {
        /**
         * 大联盟id
         */
        leagueId: number;
     ...
     * 统计查询：疲劳值查询界面
     */
    class GetFlowerStatisticsSZLeagueCmd_CS {
        /**
         * 大联盟id
         */
        leagueId: number;
     ...
     * 获取疲劳值变动记录 -- 暂时只有操作记录
     */
    class GetFlowerRecordSZLeagueCmd_CS {
        /**
         * 大联盟id
         */
        leagueId: number;
     ...
     * 统计查询：玩家明细界面
     */
    class GetUserStatisticsSZLeagueCmd_CS {
        /**
         * 大联盟id
         */
        leagueId: number;
     ...
     * 统计查询：消耗统计
     */
    class GetConsumeStatisticsSZLeagueCmd_CS {
        /**
         * 大联盟id
         */
        leagueId: number;
     ...
     * 禁入、解禁
     */
    class ForbitUserSZLeagueCmd_CS {
        /**
         * 大联盟id
         */
        leagueId: number;
     ...
     */
    class GetFlowerRestoreInfoSZLeagueCmd_CS {
        /**
         * 大联盟id
         */
        leagueId: number;
     ...
     * 进行疲劳恢复设置
     */
    class SetFlowerRestoreSZLeagueCmd_CS {
        /**
         * 大联盟id
         */
        leagueId: number;
     ...
     * 获取疲劳恢复可领取的疲劳值
     */
    class GetCurFlowerRestoreSZLeagueCmd_CS {
        /**
         * 大联盟id
         */
        leagueId: number;
     ...
     * 领取疲劳恢复的疲劳值
     */
    class RecvFlowerRestoreSZLeagueCmd_CS {
        /**
         * 大联盟id
         */
        leagueId: number;
     ...
     * 修改玩法层游戏名称
     */
    class UpdatePlayFloorGameNameSZLeagueCmd_CS {
        /**
         * 大联盟id
         */
        leagueId: number;
    ...
    class GetRankInfoSZLeagueCmd_CS {
        /**
         * 大联盟id
         */
        leagueId: number;
     ...
     * 设置凑桌模式
     */
    class SetMatchDeskSZLeagueCmd_CS {
        /**
         * 大联盟id
         */
        leagueId: number;
     ...
     * 加入匹配
     */
    class JoinMatchDeskSZLeagueCmd_CS {
        /**
         * 大联盟id
         */
        leagueId: number;
     ...
     * 取消匹配
     */
    class ExitMatchDeskSZLeagueCmd_CS {
        /**
         * 大联盟id
         */
        leagueId: number;
    ...
    class JoinMemberListSZLeagueCmd_CS {
        /**
         * 大联盟id
         */
        leagueId: number;
     ...
     * 黑白名单操作
     */
    class OperateWhiteBlackSZLeagueCmd_CS {
        uid: number;
        /**
         * 1:添加白名单 2:表示添加黑名单
         */
     ...
     * 玩家申请进入老友圈/大联盟记录
     */
    class RequestUserApplyRecordSZLeagueCmd_CS {
        /**
         * 1:老友圈记录 2大联盟记录
         */
        opType: number;
     ...
     * 黑名单信息
     */
    class RequestBlackListSZLeagueCmd_CS {
        matchId: number;
        /**
         * 是否为SZ大联盟模式 1：表示为SZ大联盟模式
         */
...
declare module Cmd {
     ...
     */
    class GetLuckShopReusltLobbyCmd_C {
        /**
         * 需要带上大厅id
         */
        lobbyId: number;
     ...
     * 更新公告广播
     */
    class UpdateVersionBroadCastLobbyCmd_Brd {
        /**
         * 广播标题
         */
        title: string;
     ...
     * 纯真年代 进入活动界面
     */
    class IntoPureTimeLobbyCmd_C {
        GetType(): string;
    }
    class IntoPureTimeLobbyCmd_S {
        resultCode: number;
        /**
         * 气球数
         */
     ...
     * 纯真年代 开启宝箱
     */
    class PureTimeOpenBoxLobbyCmd_C {
        GetType(): string;
    }
    class PureTimeOpenBoxLobbyCmd_S {
        resultCode: number;
        reward: Cmd.RewardItem;
        /**
         * 当前气球数
     ...
     * 纯真年代 领取累计开箱奖励
     */
    class PureTimeGetContinueReardLobbyCmd_C {
        /**
         * 具体开哪一个
         */
        which: number;
    ...
    class PureTimeGetContinueReardLobbyCmd_S {
        resultCode: number;
        reward: Cmd.RewardItem;
        GetType(): string;
    }
    class PureTimeRecord {
        /**
         * 奖励获取时间戳
         */
        timestamp: number;
     ...
     * 纯真年代 查看获奖记录
     */
    class PureTimeGetRecordLobbyCmd_C {
        /**
         * 分页处理 当前请求第几页 默认一页返回10个数据
         */
        curPage: number;
    ...
    class PureTimeGetRecordLobbyCmd_S {
        resultCode: number;
        /**
         * 分页处理 当前请求第几页 默认一页返回10个数据
         */
     ...
     * 纯真年代 获取个人资料
     */
    class PureTimeGetPersonalDataLobbyCmd_C {
        GetType(): string;
    }
    class PureTimeGetPersonalDataLobbyCmd_S {
        resultCode: number;
        name: string;
        phoneNumber: number;
        wx: string;
     ...
     * 纯真年代 填写个人资料
     */
    class PureTimeSetPersonalDataLobbyCmd_C {
        name: string;
        phoneNumber: number;
        wx: string;
        addr: string;
    ...
    class PureTimeSetPersonalDataLobbyCmd_S {
        resultCode: number;
        GetType(): string;
    }
    /**
     * 第三方充值
     */
    class BuyDiamond51PayLobbyCmd_C {
        /**
         * 需要购买的钻石数量
         */
        num: number;
     ...
     * 第三方充值地址
     */
    class BuyDiamond51PayLobbyCmd_S {
        /**
         * 充值地址
         */
        url: string;
     ...
     * 漳州新增转盘  进入转盘界面
     */
    class IntoZZTurnTableLobbyCmd_CS {
        /**
         * 返回码
         */
        resultCode: number;
    ...
    class GetZZTurnTableRecordsLobbyCmd_CS {
        resultCode: number;
        /**
         * 活动获奖记录
         */
     ...
     * 广东大厅推送钻石翻倍弹窗
     */
    class NotifyUserDoubleDiamondLobbyCmd_S {
        preDiamond: number;
        curDiamond: number;
        GetType(): string;
    }
     ...
     * 广东大厅推送老用户赠送钻石
     */
    class NotifyRewardOldPlayerLobbyCmd_S {
        diamond: number;
        GetType(): string;
    }
}
...
declare module Cmd {
     ...
     * 软杠挑牌
     */
    class PickBarGoldMahjongCmd_C {
        thisId: number;
        GetType(): string;
    }
    class PickBarGoldMahjongCmd_S {
        resultCode: number;
        desc: string;
        GetType(): string;
    }
     ...
     * 挑牌后的广播
     */
    class PickBarGoldMahjongCmd_Brd {
        uid: number;
        /**
         * 乐山麻将挑牌后的杠牌
         */
     ...
     * 诏安麻将请求插台
     */
    class ReqInsertTableMahjongCmd_C {
        /**
         * 插台数量 0表示不插
         */
        point: number;
    ...
    class ReqInsertTableMahjongCmd_S {
        point: number;
        GetType(): string;
    }
    class ReqInsertTableMahjongCmd_Brd {
        point: number;
        uid: number;
        GetType(): string;
    }
     ...
     * 开始插台广播
     */
    class StartInsertTableMahjongCmd_Brd {
        sec: number;
        GetType(): string;
    }
}
...
declare module Cmd {
     ...
     * 操作金币
     */
    class BSPlatOperationGoldCmd_CS {
        /**
         * 操作类型
         */
