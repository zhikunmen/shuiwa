...
module Cmd {
	...
	export class ReturnRoomUserGPSCmd_S {
		/**
		 * 位置信息
		 */
		list: IpGPS[];
		GetType(): string { return 'Cmd.ReturnRoomUserGPSCmd_S'; }
	}
	 ...
	 * 房间协议
	 */
	export class EnterRoomCommonCmd_S {
		resultCode: number;
		desc: string;
		roomState: RoomState;
		/**
		 ...
		 */
		visitor: number;
		GetType(): string { return 'Cmd.EnterRoomCommonCmd_S'; }
	}
	/**
	 * 广播玩家离开房间
	 */
	export class LeaveRoomCommonCmd_Brd {
		resultCode: number;
		desc: string;
		uid: number;
		state: number;
		GetType(): string { return 'Cmd.LeaveRoomCommonCmd_Brd'; }
	}
	/**
	 * 广播玩家进入房间
	 */
	export class EnterRoomCommonCmd_Brd {
		userInfo: UserBaseInfo;
		/**
		 * 是否第一次进
		 */
		 ...
		 */
		listened: number;
		GetType(): string { return 'Cmd.EnterRoomCommonCmd_Brd'; }
	}
}
