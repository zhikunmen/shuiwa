...
declare module shop {
    /**每日充值礼包 */
    class RechargeGiftDailyPanel extends eui.Component {
        purchase_btn: eui.WxButton;
        pay_btn: eui.WxButton;
        close_btn: eui.WxButton;
        againGift_lst: eui.List;
        give_lst: eui.List;
        gift_lst: eui.List;
        btn_lst: eui.List;
        time_lbl: eui.Label;
...
declare module shop {
    /**3元充值 */
    class ThreeRMBPanel extends eui.Component {
        purchase_btn: eui.WxButton;
        pay_btn: eui.WxButton;
        close_btn: eui.WxButton;
        reward_lst: eui.List;
        coinNum_blbl: eui.BitmapLabel;
        private _shopId;
        constructor();
        protected childrenCreated(): void;
        private onInfo(evt);
    ...
    class ThreeRMBItem extends eui.ItemRenderer {
        icon_img: eui.Image;
        give_img: eui.Image;
        mask_img: eui.Image;
        name_lbl: eui.Label;
