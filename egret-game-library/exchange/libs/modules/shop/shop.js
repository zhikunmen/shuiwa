...
(function (shop) {
    ...
    var FirstRecharge = (function (_super) {
        ...
        FirstRecharge.prototype.onInfo = function (evt) {
            ...
            info.rewads.length >= 5 && info.rewads.forEach(function (value, index) { value["scale"] = 0.8; });
...
(function (shop) {
    ...
    var MonthlyCard = (function (_super) {
        ...
        MonthlyCard.prototype.childrenCreated = function () {
            ...
            this.im_lbl.textFlow = im;
            if (this._info.firstGifts) {
                var desc = [{ text: "首次购买", style: { size: 32, textColor: 0xeaff00 } }, { text: "再送", style: { size: 28, textColor: 0xfee4ab } }];
                for (var i = 0; i < this._info.firstGifts.length; i++) {
                    i != 0 && desc.push({ text: "和", style: { size: 32, textColor: 0xeaff00 } });
                    var cfg = ConfigMgr.getInstance().getGoodCfgById(this._info.firstGifts[i].goodId);
                    var num = this._info.firstGifts[i].goodNbr;
                    desc.push({ text: "" + (num > 10000 ? num / 10000 + "万" : num) + cfg.goodName, style: { size: 28, textColor: 0xfee4a } });
                }
                this.desc_lbl.textFlow = desc;
            }
        };
...
(function (shop) {
    /**每日充值礼包 */
    var RechargeGiftDailyPanel = (function (_super) {
        __extends(RechargeGiftDailyPanel, _super);
        function RechargeGiftDailyPanel() {
            var _this = _super.call(this) || this;
            _this.skinName = "RechargeGiftDailySkin";
            return _this;
        }
        RechargeGiftDailyPanel.prototype.childrenCreated = function () {
            _super.prototype.childrenCreated.call(this);
            ...
            NetMgr.tcpSend(req);
            this.gift_lst.itemRenderer = shop.ThreeRMBItem;
            this.againGift_lst.itemRenderer = shop.ThreeRMBItem;
            this.give_lst.itemRenderer = shop.ThreeRMBItem;
            this.purchase_btn.addEventListener(egret.TouchEvent.TOUCH_TAP, this.onTouchHandler, this);
            this.close_btn.addEventListener(egret.TouchEvent.TOUCH_TAP, this.onTouchHandler, this);
            this.pay_btn.addEventListener(egret.TouchEvent.TOUCH_TAP, this.onTouchHandler, this);
            if (uniLib.Global.isWxGame() && wxgame.Utils.isIos) {
        ...
        RechargeGiftDailyPanel.prototype.onInfo = function (evt) {
            var info = evt.param;
            info.forEach(function (value, index) { value["index"] = index + 1; });
        ...
        RechargeGiftDailyPanel.prototype.onItemTap = function () {
            this.setView(this.btn_lst.selectedItem);
        };
        RechargeGiftDailyPanel.prototype.setView = function (info) {
        ...
        RechargeGiftDailyPanel.prototype.onTimer = function () {
            if (this._timer.repeatCount == this._timer.currentCount) {
                this._timer.stop();
                this.time_lbl.text = "间隔倒计时: 00：00";
            }
            else {
                var m = Math.floor((this._timer.repeatCount - this._timer.currentCount) / 60) + "";
                var s = (this._timer.repeatCount - this._timer.currentCount) % 60 + "";
                this.time_lbl.text = "\u95F4\u9694\u5012\u8BA1\u65F6: " + (m.length < 2 ? "0" + m : m) + "\uFF1A" + (s.length < 2 ? "0" + s : s);
            }
        };
        RechargeGiftDailyPanel.prototype.onTouchHandler = function (evt) {
            var _this = this;
            if (evt.target == this.purchase_btn) {
                shop.ShopControl.checkSession(ConfigMgr.getInstance().getShopCfgById(this._shopId));
                uniLib.PopUpMgr.removePopUp(this);
        ...
        RechargeGiftDailyPanel.prototype.destroy = function () {
            this._shopId = null;
        ...
        return RechargeGiftDailyPanel;
    }(eui.Component));
    shop.RechargeGiftDailyPanel = RechargeGiftDailyPanel;
    __reflect(RechargeGiftDailyPanel.prototype, "shop.RechargeGiftDailyPanel");
    var RechargeGiftDailyItem = (function (_super) {
        __extends(RechargeGiftDailyItem, _super);
        function RechargeGiftDailyItem() {
            var _this = _super.call(this) || this;
            _this.skinName = "RechargeGiftDailyItemSkin";
            return _this;
        }
        RechargeGiftDailyItem.prototype.dataChanged = function () {
            _super.prototype.dataChanged.call(this);
            var info = this.data;
        ...
        return RechargeGiftDailyItem;
    }(eui.ItemRenderer));
    __reflect(RechargeGiftDailyItem.prototype, "RechargeGiftDailyItem");
})(shop || (shop = {}));
var shop;
(function (shop) {
    /**首充信息 */
    ...
    var ShopConsts = (function () {
        ...
        ShopConsts.RES_JSON = "resource/shop/shop.res_f4c23ebb.json";
        ShopConsts.RESZZ_JSON = "resource/shopZZ.res.json";
        ShopConsts.RES_MAHJONG_JSON = "resource/shop_mahjong.res.json";
        ShopConsts.THM_JSON = "resource/shop/gameEui_a2f67c48.json";
        /**
         * 公共shop需要加载的资源组
         */
        ...
        /**每日充值礼包 */
        ShopConsts.SHOP_GIFTDAILY = "shop_giftDaily";
        return ShopConsts;
    }());
...
(function (shop) {
    /**3元充值 */
    var ThreeRMBPanel = (function (_super) {
        __extends(ThreeRMBPanel, _super);
        function ThreeRMBPanel() {
            var _this = _super.call(this) || this;
            _this.skinName = "ThreeRMBSkin";
            return _this;
        }
        ThreeRMBPanel.prototype.childrenCreated = function () {
            _super.prototype.childrenCreated.call(this);
            uniLib.Global.addEventListener(shop.FIRST_RECHARGE_INFO, this.onInfo, this);
            NetMgr.tcpSend(new Cmd.GetFirstchargeInfoHpMatchCmd_C());
            this.purchase_btn.addEventListener(egret.TouchEvent.TOUCH_TAP, this.onTouchHandler, this);
        ...
        ThreeRMBPanel.prototype.onInfo = function (evt) {
            var info = evt.param;
            this._shopId = info.goodid;
            this.reward_lst.itemRenderer = ThreeRMBItem;
            for (var i = 0; i < info.rewads.length; i++) {
        ...
        ThreeRMBPanel.prototype.onTouchHandler = function (evt) {
            var _this = this;
            if (evt.target == this.purchase_btn) {
                shop.ShopControl.checkSession(ConfigMgr.getInstance().getShopCfgById(this._shopId));
                uniLib.PopUpMgr.removePopUp(this);
        ...
        ThreeRMBPanel.prototype.destroy = function () {
            this._shopId = null;
            uniLib.Global.removeEventListener(shop.FIRST_RECHARGE_INFO, this.onInfo, this);
            this.purchase_btn.removeEventListener(egret.TouchEvent.TOUCH_TAP, this.onTouchHandler, this);
            this.close_btn.removeEventListener(egret.TouchEvent.TOUCH_TAP, this.onTouchHandler, this);
        ...
        return ThreeRMBPanel;
    }(eui.Component));
    shop.ThreeRMBPanel = ThreeRMBPanel;
    __reflect(ThreeRMBPanel.prototype, "shop.ThreeRMBPanel");
    var ThreeRMBItem = (function (_super) {
        __extends(ThreeRMBItem, _super);
        function ThreeRMBItem() {
            var _this = _super.call(this) || this;
            _this.skinName = "ThreeRMBItemSkin";
            return _this;
        }
        ThreeRMBItem.prototype.dataChanged = function () {
            _super.prototype.dataChanged.call(this);
            var info = this.data;
            var goodCfg = ConfigMgr.getInstance().getGoodCfgById(info.goodId);
    ...
    shop.ThreeRMBItem = ThreeRMBItem;
    __reflect(ThreeRMBItem.prototype, "shop.ThreeRMBItem");
})(shop || (shop = {}));
var eui;
(function (eui) {
