...
(function (exchange) {
    var ExchangeConst = (function () {
        ...
        ExchangeConst.RES_JSON = "resource/exchange/exchange.res_3af3676b.json";
        ExchangeConst.THM_JSON = "resource/exchange/gameEui_57791846.json";
        /**
         * 公共loading需要加载的资源组
         */
...
(function (exchange) {
    var ExchangeVC = (function (_super) {
        ...
        function ExchangeVC(selectIndex, customerQQ) {
            if (selectIndex === void 0) { selectIndex = 0; }
            var _this = _super.call(this) || this;
            _this._selectIndex = selectIndex;
            _this._customerQQ = customerQQ;
        ...
        ExchangeVC.prototype.childrenCreated = function () {
            ...
            if (this._customerQQ)
                this.tips_lbl.textFlow = [{ text: "（兑换可能有几分钟延时，请耐心等待。如未到账，请", style: { textColor: 0xffffff } }, { text: "联系客服QQ：" + this._customerQQ, style: { underline: true, textColor: 0x1450A7 } }, { text: "）", style: { textColor: 0xffffff } }];
            else
