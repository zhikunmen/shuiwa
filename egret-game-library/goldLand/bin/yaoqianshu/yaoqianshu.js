...
(function (yaoqianshu) {
    var YaoQianShuConsts = (function () {
        ...
        YaoQianShuConsts.RES_JSON = "resource/yaoqianshu/yaoqianshu.res_13e8f3c6.json";
        YaoQianShuConsts.THM_JSON = "resource/yaoqianshu/gameEui_3de05bcc.json";
        /**
         * 公共guide需要加载的资源组
         */
    ...
    var YaoQianShuPanel = (function (_super) {
        ...
        YaoQianShuPanel.prototype.onTouchHandle = function (e) {
            ...
            if (target == this._closeBtn) {
                ...
                if (MJLobbyData.getInstance().ismcardvalid) {
                    this.getReward();
                }
                else {
                    this.getMonthCard();
