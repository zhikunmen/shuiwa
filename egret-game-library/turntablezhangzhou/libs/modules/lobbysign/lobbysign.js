...
(function (lobbysign) {
    var SignConst = (function () {
        ...
        SignConst.THM_JSON = "resource/lobbysign/gameEui_750ce420.json";
        /**
         * 公共loading需要加载的资源组
         */
...
(function (lobbysign) {
    var SignDayOfWeekItemPanel = (function (_super) {
        ...
        SignDayOfWeekItemPanel.prototype.dataChanged = function () {
            ...
            if (!Data.sign[0] || !Data.sign[0].signReward[this.itemIndex])
                return;
            this._sRewardTabledata = Data.sign[0].signReward[this.itemIndex];
...
(function (lobbysign) {
    var SignRewardItemPanel = (function (_super) {
        ...
        SignRewardItemPanel.prototype.dataChanged = function () {
            ...
            if (!Data.sign[0] || !Data.sign[0].cumulativeReward[this.itemIndex])
                return;
            this._cRewardTabledata = Data.sign[0].cumulativeReward[this.itemIndex];
            ...
            this.goldTxt.text = this._cRewardTabledata.reward.count + Data.goods[this._cRewardTabledata.reward.goodsId].goodName;
