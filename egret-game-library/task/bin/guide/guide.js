...
(function (guide) {
    var YaoQianShuConsts = (function () {
        ...
        YaoQianShuConsts.RES_JSON = "resource/yaoqianshu.res.json";
        YaoQianShuConsts.THM_JSON = "resource/gameEui.json";
        /**
         * 公共guide需要加载的资源组
         */
        YaoQianShuConsts.PUB_GUIDE_FIRST = "pub_yaoqianshu";
        return YaoQianShuConsts;
    }());
    guide.YaoQianShuConsts = YaoQianShuConsts;
    __reflect(YaoQianShuConsts.prototype, "guide.YaoQianShuConsts");
})(guide || (guide = {}));
var yaoqianshu;
(function (yaoqianshu) {
    var YaoQianShuPanel = (function (_super) {
        ...
        YaoQianShuPanel.prototype.onTouchHandle = function (e) {
            var _this = this;
            var target = e.target;
            if (target == this._pickUp) {
                this.getReward();
            }
            else if (target == this._anim) {
                this.playAnim(this.GOLDTREE_YAODONG);
                // this._anim.play(this.GOLDTREE_YAODONG);
                this.clear();
        ...
        YaoQianShuPanel.prototype.treeShake = function (goldNum) {
            if (goldNum > ((this.moneyTreeData.level - 1) * 60 + 1000) * 5) {
