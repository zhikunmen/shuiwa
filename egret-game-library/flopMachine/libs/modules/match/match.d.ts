...
declare module match {
    ...
    class WxBuyuGoodItem extends egret.DisplayObjectContainer {
        private _goodId;
...
declare module match {
     ...
     * goodId转汉字
     */
    function getDescByGoodId(goodId: number): "金币" | "钻石" | "福卡";
    /**判断道具是否足够 */
...
declare module match {
    ...
    class WxRushGameDetail extends eui.Component {
        ...
        sign_btn: eui.WxButton;
        close_btn: eui.WxButton;
        rewardType_img: eui.Image;
        title_lbl: eui.Label;
        cost_lbl: eui.Label;
        lastRush_lbl: eui.Label;
        lastReward_lbl: eui.Label;
        rush_grp: eui.Group;
        rule_lbl: eui.Label;
        private _data;
        private _gameId;
