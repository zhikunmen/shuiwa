                ...
                var _loop_1 = function (i) {
                    if (this_1._rushData[i].type == type) {
                        ...
                        LoadPanelTipMgr.getInstance().loadRes(match.MatchConst.HPW_RUSH, function () {
                            uniLib.PopUpMgr.addPopUp(match.WxRushGameDetail, null, true, false, 0, uniLib.PopUpEffect.NOMAL, 0, 0, { info: _this._rushData[i], gameId: match.GameId.ID_COIN_FOUCA });
                        });
                        return "break";
                    }
                };
...
(function (match) {
    ...
    var MatchConst = (function () {
        ...
        MatchConst.RES_JSON = "resource/match/wxmatch.res_20839d2a.json";
        MatchConst.THM_JSON = "resource/match/gameEui_85249fd8.json";
        /**
         * 主界面需要加载的资源
         */
...
(function (match) {
    var WxMahjongSelect = (function (_super) {
        ...
        WxMahjongSelect.prototype.enterGame = function (senceId) {
            LoadGameTipUtil.loadGame(this._gameId, function (gameData) {
                MsgSendMgr.enterGame(gameData.gameId, 2, senceId);
            });
        };
