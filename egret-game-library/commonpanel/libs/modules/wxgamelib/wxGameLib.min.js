 ...
 * @licence wxGameLib - v0.1.0 (2018-09-10)
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    return [2 /*return*/, new Promise(function (resolve, reject) {
                            wx.shareAppMessage({
                                title: title,
                                imageUrl: "https://wx.qlogo.cn/mmopen/vi_32/UNKRHmoD4IW9E1F5xRdFldhslX9ia1ppJjPlvsIBp6UbVfDlzOd8hwr4Evn60KgRZlebZia46gtCxKrO8PicEuw3g/132",
                                query: query,
                                success: function (res) {
                                    console.log(res);
                                    if (success)
