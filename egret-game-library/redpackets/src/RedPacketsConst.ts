module redpackets {
	export class RedPacketsConst {
		public static RES_JSON = "resource/redpackets.res.json";

		public static THM_JSON = "resource/gameEui.json";
		/**
		 * 公共loading需要加载的资源组
		 */
		public static PUB_REDPACKETS: string = "pub_redpackets";
		/**邀请有礼界面 */
		public static SHARE_INVITEDATA: string = "share_invitedata";
		/**领取奖励 */
		public static SHARE_INVITEAWARD: string = "share_inviteaward";
		/**不可以领取邀请奖励通知 */
		public static NOTCAN_GETINVITE: string = "notcanGetInvite";
	}
