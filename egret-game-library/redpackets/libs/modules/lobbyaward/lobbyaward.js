...
(function (lobbyaward) {
    var AwardConst = (function () {
        ...
        AwardConst.RES_JSON = "resource/lobbyaward/lobbyaward.res_6e2faf6e.json";
        AwardConst.THM_JSON = "resource/lobbyaward/gameEui_d3a83c26.json";
        /**
         * 公共loading需要加载的资源组
         */
...
(function (lobbyaward) {
    var LobbyGetAwardPanel = (function (_super) {
        ...
        LobbyGetAwardPanel.prototype.setData = function (jinbi, type) {
            ...
            if (type == 3) {
                this.awardimage.source = "mjl_redpackets_award"; //现金
                this.jinbiText.text = jinbi + "元"; //奖励金币数
            }
