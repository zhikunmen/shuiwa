module club {
    ...
    /**合伙人 添加成员*/
    export class ClubPartnerImportAddPanel extends commonpanel.LobbyBaseEuiPanel {
        /**搜索按钮 */
        ...
        protected initUI(): void {
            this._menberList.itemRenderer = ClubPartnerImportAddItemPanel;
        }
        ...
        private searchMember(value: string): void {
            ...
            let ClubMemberList = ClubData.getInstance().PartnerImportList;
