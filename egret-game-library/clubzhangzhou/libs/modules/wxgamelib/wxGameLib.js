 ...
 * @licence wxGameLib - v0.1.0 (2019-03-18)
            ...
            if (uniLib.Global.isWxGame()) {
                if (this.videoAdCanUse == false) {
                    ...
                    if (this._videoAd) {
                        ...
                        this._videoAd.show().then(function () { _this.videoAdCanUse = true; uniLib.SoundMgr.instance.pauseBgMusic(); }, function () {
...
(function (wxgame) {
    var ShareMessage = /** @class */ (function () {
         ...
         * @param shareVo 分享数据
         */
        ShareMessage.prototype.shareAppMessage = function (shareVo, success, fail, callObj) {
            return __awaiter(this, void 0, void 0, function () {
                var _this = this;
                var title, imageUrl, random, table, query, obj, time_1, needbrc_1;
                return __generator(this, function (_a) {
                    ...
                    if (success || fail) {
                        needbrc_1 = uniLib.Global.initOpt.needbackReconnect;
                        uniLib.Global.initOpt.needbackReconnect = false;
                        egret.MainContext.instance.stage.once(egret.Event.DEACTIVATE, function () { time_1 = (new Date()).getTime(); }, this);
                        egret.MainContext.instance.stage.once(egret.Event.ACTIVATE, function () {
                            egret.callLater(function () {
                                uniLib.Global.initOpt.needbackReconnect = needbrc_1;
                            }, _this);
                            if ((new Date()).getTime() - time_1 < 2500) {
                                fail && fail.call(callObj);
                            }
                            else {
                                _this.sendShareMessage(shareVo);
                                success && success.call(callObj);
                            }
                        }, this);
                    }
                    wx.shareAppMessage({
