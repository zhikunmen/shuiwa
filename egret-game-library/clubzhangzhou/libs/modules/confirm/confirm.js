...
(function (commonConfirm) {
    var ConfirmConsts = (function () {
        ...
        ConfirmConsts.RES_JSON = "resource/confirm/confirm.res_7f1584d0.json";
        ConfirmConsts.THM_JSON = "resource/confirm/gameEui_b92afbb0.json";
        /**
         * 公共confirm需要加载的资源组
         */
...
(function (eui) {
    ...
    var ArmatureComponent = (function (_super) {
         ...
         * @param 偏移量
         */
        ArmatureComponent.prototype.setNewSlot = function (slotName, textureName, offsetX, offsetY) {
