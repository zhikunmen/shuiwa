declare module loading {
    class LoadingConst {
        ...
        static RES_JSON_HCMAJHONG: string;
        static RES_JSON_LAOYOU_GUANGDONG: string;
        static RES_JSON_HCBUYU: string;
...
declare module loading {
     ...
     * 捕鱼加载不带版本号文字
     */
    class PublicLoadingHCBuYu extends eui.Component {
...
declare module loading {
     ...
     * 捕鱼加载带版本号文字
     */
    class PublicLoadingHCFish extends eui.Component {
        private _darkLine_bmp;
        private _lightLine_bmp;
        private _explain_txf;
        private _versionTxt;
...
declare module loading {
     ...
     * 公共加载
     */
    class PublicLoadingHCMahjong extends eui.Component {
        private _darkLine_bmp;
        private _lightLine_bmp;
        private _explain_txf;
        private _versionTxt;
