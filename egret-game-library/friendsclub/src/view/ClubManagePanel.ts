module friendsclub {
    export class ClubManagePanel extends commonpanel.LobbyBaseEuiPanel {
        ...
        private _closeBtn: eui.Button;         //关闭页面

        private _refreshbtn: eui.Button;      // 刷新按钮
        private _clubtypebtn: eui.Button;     //暂停开房和恢复开房按钮
        private _dissclubbtn: eui.Button;     //解散按钮
        private _setbtn: eui.Button;          //设置按钮
        ...
        private addWhiteButton: eui.Button;        //白名单按钮
        private addBlackButton: eui.Button;         //黑名单按钮
        ...
        constructor() {
            ...
            this._detailsGroup.visible = false;
            this._messageGroup.visible = false;
            this._memberGroup.visible = false;
            this._fightingGroup.visible = false;
            this._blackandwhiteGroup.visible = false;
