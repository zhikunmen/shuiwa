...
(function (Cmd) {
    ...
    var ddz_CommonChat_C = (function () {
        function ddz_CommonChat_C() {
        }
        ddz_CommonChat_C.prototype.GetType = function () { return 'Cmd.ddz_CommonChat_C'; };
        return ddz_CommonChat_C;
    }());
    Cmd.ddz_CommonChat_C = ddz_CommonChat_C;
    __reflect(ddz_CommonChat_C.prototype, "Cmd.ddz_CommonChat_C");
    var ddz_CommonChat_S = (function () {
        function ddz_CommonChat_S() {
        }
        ddz_CommonChat_S.prototype.GetType = function () { return 'Cmd.ddz_CommonChat_S'; };
        return ddz_CommonChat_S;
    }());
    Cmd.ddz_CommonChat_S = ddz_CommonChat_S;
    __reflect(ddz_CommonChat_S.prototype, "Cmd.ddz_CommonChat_S");
    var ddz_CommonChat_Brd = (function () {
        function ddz_CommonChat_Brd() {
        }
        ddz_CommonChat_Brd.prototype.GetType = function () { return 'Cmd.ddz_CommonChat_Brd'; };
        return ddz_CommonChat_Brd;
    }());
    Cmd.ddz_CommonChat_Brd = ddz_CommonChat_Brd;
    __reflect(ddz_CommonChat_Brd.prototype, "Cmd.ddz_CommonChat_Brd");
     ...
     * 请求ip和gps获取经度纬度
     */
    var RequestIpGPSPokerCmd_C = (function () {
        function RequestIpGPSPokerCmd_C() {
        }
        RequestIpGPSPokerCmd_C.prototype.GetType = function () { return 'Cmd.RequestIpGPSPokerCmd_C'; };
        return RequestIpGPSPokerCmd_C;
    }());
    Cmd.RequestIpGPSPokerCmd_C = RequestIpGPSPokerCmd_C;
    __reflect(RequestIpGPSPokerCmd_C.prototype, "Cmd.RequestIpGPSPokerCmd_C");
    /**
     * 返回ip和gps获取经度纬度
     */
    var ReturnIpAndGPSPokerCmd_S = (function () {
        function ReturnIpAndGPSPokerCmd_S() {
        }
        ReturnIpAndGPSPokerCmd_S.prototype.GetType = function () { return 'Cmd.ReturnIpAndGPSPokerCmd_S'; };
        return ReturnIpAndGPSPokerCmd_S;
    }());
    Cmd.ReturnIpAndGPSPokerCmd_S = ReturnIpAndGPSPokerCmd_S;
    __reflect(ReturnIpAndGPSPokerCmd_S.prototype, "Cmd.ReturnIpAndGPSPokerCmd_S");
    var IpGPSPoker = (function () {
        function IpGPSPoker() {
        }
        IpGPSPoker.prototype.GetType = function () { return 'Cmd.IpGPSPoker'; };
        return IpGPSPoker;
    }());
    Cmd.IpGPSPoker = IpGPSPoker;
    __reflect(IpGPSPoker.prototype, "Cmd.IpGPSPoker");
    /**
     * +
     */
...
(function (Cmd) {
    ...
    var PokerRoundScore = (function () {
        function PokerRoundScore() {
        }
        PokerRoundScore.prototype.GetType = function () { return 'Cmd.PokerRoundScore'; };
        ;
        return PokerRoundScore;
    }());
    Cmd.PokerRoundScore = PokerRoundScore;
    __reflect(PokerRoundScore.prototype, "Cmd.PokerRoundScore");
    var ShowPokerRoundScore_S = (function () {
        function ShowPokerRoundScore_S() {
        }
        ShowPokerRoundScore_S.prototype.GetType = function () { return 'Cmd.ShowPokerRoundScore_S'; };
        ;
        return ShowPokerRoundScore_S;
    }());
    Cmd.ShowPokerRoundScore_S = ShowPokerRoundScore_S;
    __reflect(ShowPokerRoundScore_S.prototype, "Cmd.ShowPokerRoundScore_S");
    /**
     * 玩家简单信息
     */
