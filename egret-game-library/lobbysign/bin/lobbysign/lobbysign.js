...
(function (lobbysign) {
    var SignDayOfWeekItemPanel = (function (_super) {
        ...
        SignDayOfWeekItemPanel.prototype.dataChanged = function () {
            ...
            if (!MJLobbyData.getInstance().sign[0] || !MJLobbyData.getInstance().sign[0].signReward[this.itemIndex])
                return;
...
(function (lobbysign) {
    var SignRewardItemPanel = (function (_super) {
        ...
        SignRewardItemPanel.prototype.dataChanged = function () {
            ...
            if (!MJLobbyData.getInstance().sign[0] || !MJLobbyData.getInstance().sign[0].cumulativeReward[this.itemIndex])
                return;
