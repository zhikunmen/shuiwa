...
(function (loading) {
    var LoadingConst = (function () {
        ...
        LoadingConst.RES_JSON = "resource/loading/loading.res_f7bf474f.json";
        ...
        LoadingConst.THM_JSON = "resource/loading/gameEui_4c05399c.json";
        /**
         * 公共loading需要加载的资源组
         */
                ...
                if (num >= 93) {
                    if (!this._timer) {
                        this._timer = egret.setInterval(function () {
                            _this._time++;
                            if (_this._time >= 8 && uniLib.Global.isWxGame()) {
    ...
    var PublicLoadingZZView = (function (_super) {
        ...
        PublicLoadingZZView.prototype.setProgress = function (loaded, total, desc, resourceName, force) {
            ...
            if (total && total != 0) {
                ...
                var widthX = (this._darkLine_bmp.width) * (num_2 / 100);
                this._lightLine_bmp.width = widthX;
            }
            else {
                this._explain_txf.text = desc;
