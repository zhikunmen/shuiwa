...
declare module Cmd {
     ...
     * 返回ip和gps获取经度纬度
     */
    class ReturnIpAndGPSPokerCmd_S {
        /**
         * 位置信息
         */
        list: IpGPSPoker[];
