...
declare module Cmd {
    ...
    /**楼层系列操作 */
    function OnOperateFloorMatchGroupCmd_CS(rev: Cmd.OperateFloorMatchGroupCmd_CS): void;
    /**进房审核 */
...
declare module clubnew {
    class ClubModuleMgr {
        ...
        /**创建老友圈房间面板 */
        showCreateClubPanel(game?: Cmd.OperateFloorMatchGroupCmd_CS): void;
        /**显示老友圈查看个人信息面板 */
        showClubUserInfoPanel(callBack: Function): void;
        /**
         * 俱乐部创建、修改设置页面
         */
        showCreateMatchSetPanel(data: Cmd.CreateRoomCmd_C | Cmd.ChangeMatchGroupCmd_S | Cmd.OperateFloorMatchGroupCmd_CS): void;
        /**老友圈左侧包厢功能 */
...
declare module clubnew {
    class ClubSendMgr {
         ...
         * 操作楼层
         */
        static sendOFMGCmd_CS(matchId: number, floorId: number, opType: number, obj?: Cmd.CreateRoomCmd_C): void;
    }
}
...
declare module clubnew {
     ...
     * 免责申明
     */
    class MatchMsgBox extends commonpanel.LobbyBaseEuiPanel {
        private title;
        private info;
        private confirm;
        private _closebtn;
