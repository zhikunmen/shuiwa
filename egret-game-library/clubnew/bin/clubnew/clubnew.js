...
(function (clubnew) {
    var ClubMsgMcPanel = (function (_super) {
        ...
        ClubMsgMcPanel.prototype.startScroll = function () {
            ...
            var w = this._noticePanel.width < 320 ? 320 : this._noticePanel.width;
...
(function (clubnew) {
    var ClubConst = (function () {
        ...
        ClubConst.RES_JSON = "resource/clubnew/clubnew.res_efc694ad.json";
        ClubConst.THM_JSON = "resource/clubnew/gameEui_bc9e9b1e.json";
        /**
         * 公共loading需要加载的资源组
         */
        ClubConst.PUB_CLUBNEW = "pub_clubnew";
        /** */
    ...
    function OnReturnMatchGroupCmd_S(rev) {
        if (uniLib.Global.isInGame == false) {
            if (rev.isClub == 1) {
                ...
                clubnew.ClubModuleMgr.getInstance().showClubManagePanel(function () {
...
(function (clubnew) {
    var ClubModuleMgr = (function () {
        ...
        ClubModuleMgr.prototype.showAllClubListPanel = function (callBack) {
            LoadPanelTipMgr.getInstance().loadRes(clubnew.ClubConst.PUB_CLUBNEW, function () {
...
(function (clubnew) {
    ...
    var ClubDeskPanel = (function (_super) {
        ...
        ClubDeskPanel.prototype.initUI = function () {
            ...
            this._bg1.width = this._bg2.width = uniLib.Global.screenWidth / 2;
        };
        ...
        ClubDeskPanel.prototype.movelistmove = function (e) {
            ...
            movex = -this.deskList.scrollH / (this.deskList.contentWidth) * (this.bg.width / 2);
            egret.Tween.get(this.bg).to({ x: movex }, 1);
        };
        ClubDeskPanel.prototype.setDate = function (evt) {
            ...
            if (this._curMath) {
                ...
                */
                ...
                this.gameIconImg.source = clubnew.ClubData.getInstance().getGameIcon(this._curMath.gameId);
                var list = [];
...
(function (clubnew) {
    ...
    var ClubItemDesk = (function (_super) {
        ...
        ClubItemDesk.prototype.dataChanged = function () {
            for (var i = 0; i < this.deskGroup.numChildren; i++) {
...
(function (clubnew) {
    var ClubManagePanel = (function (_super) {
        ...
        ClubManagePanel.prototype.settypeBtnStatus = function () {
...
(function (clubnew) {
    var ClubData = (function () {
        ...
        ClubData.prototype.getGameIcon = function (gameid) {
            var config = ConfigMgr.getInstance().getGameCfgById(gameid);
...
(function (clubnew) {
    var ClubNewBoxItemPanel = (function (_super) {
        ...
        ClubNewBoxItemPanel.prototype.dataChanged = function () {
            this.info = this.data;
            if (this.info.gameId) {
                this._gameIconImg.source = clubnew.ClubData.getInstance().getGameIcon(this.info.gameId);
