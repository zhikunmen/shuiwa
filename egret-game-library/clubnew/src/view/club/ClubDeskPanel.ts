module clubnew {
    ...
    export class ClubDeskPanel extends commonpanel.LobbyBaseEuiPanel {
        ...
        private memberListBtn: eui.Image;
        ...
        private switchFloorBtn: eui.WxButton;
        private floorUpBtn: eui.WxButton;
        private floorDownBtn: eui.WxButton;
        ...
        private _bg1: eui.Image;
        private _bg2: eui.Image;
        /**跑马灯 */
        ...
        public setDate(evt: uniLib.ZqEvent): void {
            ...
            if (this._curMath) {
                ...
                */
                ...
                this.gameIconImg.source = ClubData.getInstance().getGameIcon(this._curMath.gameId)
