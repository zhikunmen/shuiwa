...
(function (gamegps) {
    var ShareConst = (function () {
        ...
        ShareConst.RES_JSON = "resource/gamegps.res.json";
        ShareConst.THM_JSON = "resource/gameEui.json";
        /**
         * 公共loading需要加载的资源组
         */
        ShareConst.GAME_GPS = "game_gps";
        return ShareConst;
    }());
    gamegps.ShareConst = ShareConst;
    __reflect(ShareConst.prototype, "gamegps.ShareConst");
})(gamegps || (gamegps = {}));
var gamegps;
(function (gamegps) {
    //下注详情面版
    var GameGpsPanel = (function (_super) {
        ...
        GameGpsPanel.prototype.initUI = function () {
            ...
            this._btn_close.addEventListener(egret.TouchEvent.TOUCH_TAP, this.closeGPS, this);
            this._btn_leave.addEventListener(egret.TouchEvent.TOUCH_TAP, this.onLeave, this);
        };
        //重置面版到初始状态
        GameGpsPanel.prototype.reset = function () {
            //重置显示元素
            switch (RoomInfo.getInstance().playerNumber) {
                case 2:
                ...
                case 4:
                    ...
                    break;
                default:
                    console.warn("\u623F\u95F4\u4EBA\u6570\u4E0D\u6B63\u786E:" + RoomInfo.getInstance().playerNumber);
                    break;
            }
            this.isWarn = false;
        ...
        GameGpsPanel.prototype.initPanel = function () {
            ...
            //初始化数据
            var userIndex = 1;
            for (var _i = 0, _a = RoomInfo.getInstance().userList; _i < _a.length; _i++) {
                var user = _a[_i];
                if (true) {
                    //随机生成经纬度数据
                ...
                var seatMap = new Map();
                var groupEleName = "_user_group_" + RoomInfo.getInstance().playerNumber + "_" + userIndex;
                var headImgName = "_user_headImg_" + RoomInfo.getInstance().playerNumber + "_" + userIndex;
                var userNameEle = "_user_name_" + RoomInfo.getInstance().playerNumber + "_" + userIndex;
        ...
        GameGpsPanel.prototype.hasPop = function (userVo1, userVo2) {
            ...
            //没有则弹出距离过近打开面版
            this.dispatchEventWith(UIEventConsts.SHOW_GPS);
            //加入列队
        ...
        GameGpsPanel.prototype.destroy2 = function () {
            ...
            this._btn_close.removeEventListener(egret.TouchEvent.TOUCH_TAP, this.closeGPS, this);
