...
(function (pokerset) {
    var pokersetConst = (function () {
        ...
        pokersetConst.THM_JSON = "resource/pokerset/gameEui_4089ecfe.json";
        /**
         * 公共loading需要加载的资源组
         */
        /**个人信息面板资源 */
...
(function (pokerset) {
    var RemoveRoom = (function (_super) {
        ...
        RemoveRoom.prototype.setText = function (str) {
            this.txt.text = str;
        };
...
(function (pokerset) {
    var SetPanel = (function (_super) {
        ...
        SetPanel.prototype.setType = function (num, index, isGame) {
        ...
        SetPanel.prototype.setBtn = function (isGame) {
            if (this.roomType == 1) {
        ...
        */
        ...
        SetPanel.prototype.onLeave = function () {
